...
describe("Frigora Refrigerant event", () => {
  ...
  it("resolves frigora@0.19.0 from catalog with refrigerant event admission", () => {
    ...
    assert.match(platformVentureRegistry.resolve("frigora").description, /F3\.0 structured parts and refrigerant catalogues/);
    assert.match(platformVentureRegistry.resolve("frigora").description, /without inventory/);
