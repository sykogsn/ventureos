...
describe("Frigora runtime product-version observability", () => {
  it("exposes frigora@0.21.0 from the Definition Registry on the public manifest", () => {
