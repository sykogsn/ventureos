...
export const platformVentureCatalog: VentureDefinitionManifest[] = [
  ...
  createVentureManifest({
    ...
    description:
      "Frigora is a VentureOS venture. Customer, Site, Asset, WorkOrder identity, current WorkOrder assignment, Visit attendance identity, Visit field capture, Visit technical findings, Visit corrective actions, Visit outcomes, Visit recommended actions, Visit refrigerant events, Visit part usages, Asset history projection, Asset operational condition assertions, Visit customer acknowledgements, Visit evidence, F2.1 Work Execution, F2.2 Service Desk & Dispatch, and F2.3 Engineer Job Workflow are part of this definition version. F2.2 admits persisted service windows, assignment coordination, exact-assignee acceptance or decline, derived dispatch readiness and attention, and the Service Desk day board without a second WorkOrder lifecycle or automatic Visit creation. F2.3 admits the engineer job workflow on certified My Work / Visit Recorder foundations, current-assignee operational authority, Visit attendance integrity, Visit Evidence capture under assignment, protected evidence read policy, and stale-assignee revocation after reassignment, without offline/PWA packaging, customer signature, or CSAM. full diagnosis workflow, root cause, full repair workflow, parts catalogue, inventory, cylinder inventory, PPM, commercial operations, FACT → PATTERN → SIGNAL, and employee agents are not.",
    owner: "founder",
    version: "0.18.0",
    lifecycle: "concept",
    maturity: "experimental",
