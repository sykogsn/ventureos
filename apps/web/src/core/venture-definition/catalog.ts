...
export const platformVentureCatalog: VentureDefinitionManifest[] = [
  ...
  createVentureManifest({
    ...
    description:
      "Frigora is a VentureOS venture. Customer, Site, Asset, WorkOrder identity, current WorkOrder assignment, Visit attendance identity, Visit field capture, Visit technical findings, Visit corrective actions, Visit outcomes, Visit recommended actions, Visit refrigerant events, and Visit part usages are part of this definition version. Work execution, dispatch, full diagnosis workflow, root cause, full repair workflow, parts catalogue, inventory, cylinder inventory, evidence, PPM, commercial operations, FACT → PATTERN → SIGNAL, and employee agents are not.",
    owner: "founder",
    version: "0.12.0",
    lifecycle: "concept",
    maturity: "experimental",
