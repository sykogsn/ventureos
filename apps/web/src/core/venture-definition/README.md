...
| `frigora`           | 0.18.0  | Frigora           | concept    | Full intelligence pack including briefing. Customer, Site, Asset, WorkOrder identity, current assignment, Visit attendance and facts, Visit evidence, F2.1 Work Execution, and F2.2 Service Desk & Dispatch admitted beside VIC; F2.3 Engineer Job Workflow is not yet admitted |
