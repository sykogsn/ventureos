...
**Related Documents.** [Architecture Decision Register](./Architecture-Decision-Register.md) · [Roadmap Register](./Roadmap-Register.md) · [Products](../06-PRODUCTS/README.md) · [Frigora Programme 1](../06-PRODUCTS/Frigora/Programme-1.md) (FD-007 programme lock · FD-008 F2.1 scope lock · FD-009 F2.1 certified-baseline admission)
