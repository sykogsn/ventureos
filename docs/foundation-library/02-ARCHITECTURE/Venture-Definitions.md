...
| `frigora` | 0.10.0 | Frigora | concept | Full intelligence pack including briefing. Customer, Site, Asset, WorkOrder identity, current assignment, Visit attendance, Visit field capture, Visit technical findings, Visit corrective actions, Visit outcomes, and Visit recommended actions admitted beside VIC |
