...
| `frigora`           | 0.18.0  | Frigora           | concept    | Full intelligence pack including briefing. Customer, Site, Asset, WorkOrder identity, current assignment, Visit attendance and facts, Visit evidence, F2.1 Work Execution, F2.2 Service Desk & Dispatch, and F2.3 Engineer Job Workflow admitted beside VIC; Programme 1 milestones complete; Programme 1 READY FOR CONTROL CERTIFICATION PERMANENCE |
