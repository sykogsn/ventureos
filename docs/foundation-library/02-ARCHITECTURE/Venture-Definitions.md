...
| `frigora`           | 0.20.0  | Frigora           | concept    | Full intelligence pack including briefing. Customer, Site, Asset, WorkOrder identity, current assignment, Visit attendance and facts, Visit evidence, F2.1–F2.3 (Programme 1 certified at `frigora@0.18.0`), F3.0 structured parts/refrigerant catalogues, and F3.1 Time & Materials customer charge (ZAR cents snapshots) admitted beside VIC; inventory, procurement, invoice, quote, VAT, and payroll remain excluded |
