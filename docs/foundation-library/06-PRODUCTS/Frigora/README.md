...
**Authority.** Product page. Live definition: `frigora@0.7.0` in the Definition Registry.
...
**Status.** Concept (definition); atmosphere not painted; operational product not built beyond Customer, Site, Asset, WorkOrder identity, current WorkOrder assignment, Visit attendance identity, Visit field capture, and Visit technical findings
...
Frigora is a VentureOS venture. This definition admits Customer, Site, Asset, WorkOrder identity, current WorkOrder assignment, Visit attendance identity, Visit field capture, and Visit technical findings as durable operational records beside VIC. Work execution, dispatch, full diagnosis workflow, root cause, repair, evidence, PPM, refrigerant events, commercial operations, FACT → PATTERN → SIGNAL, employee agents, and field workflows are not part of this definition version.
