...
| Frigora           | `frigora`           | concept    | None (full desk; Programme 1 certified at `frigora@0.18.0`; live `frigora@0.19.0` admits F3.0 structured parts/refrigerant catalogues; inventory and costing remain excluded) |
