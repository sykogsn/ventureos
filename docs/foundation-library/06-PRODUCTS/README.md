...
| Frigora           | `frigora`           | concept    | None (full desk; Programme 1 certified at `frigora@0.18.0`; live `frigora@0.21.0` admits F3.0 catalogues, F3.1 Time & Materials customer charge, and F3.2 Mobile / PWA Delivery; inventory, procurement, invoice, quote, VAT, payroll, and F3.3 offline mutation/sync remain excluded) |
